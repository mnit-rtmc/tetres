 ...
 */
public class LocalOSMTileFactoryInfo extends TileFactoryInfo {
	...
	public LocalOSMTileFactoryInfo(String name, String baseURL, int minimumZoomLevel, int maximumZoomLevel, int totalMapZoom,
