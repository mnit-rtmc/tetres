 ...
 */
public class RouteCreateDialog extends javax.swing.JDialog {
     ...
     */
    public RouteCreateDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public RouteCreateDialog(java.awt.Frame parent, boolean modal, Corridor corr) {
        super(parent, modal);
        initComponents();
        this.parentFrame = parent;        
        this.init(corr);
