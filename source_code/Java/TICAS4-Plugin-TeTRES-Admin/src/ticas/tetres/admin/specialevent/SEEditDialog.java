...
public final class SEEditDialog extends javax.swing.JDialog {
    ...
    private void saveOrUpdate() {
        ...
        if (name.isEmpty()) {
            JOptionPane.showMessageDialog(TeTRESConfig.mainFrame, "Name is required. Please enter the name of special event.");
            return;
        }
        ...
        if (seiToUpdate.attendance == null || seiToUpdate.attendance < 0) {
            JOptionPane.showMessageDialog(TeTRESConfig.mainFrame, "Attendance is required. Please enter the attendance of the special event as positive integer.");
            return;
        }
        if (this.selectedCoordinate == null) {
            JOptionPane.showMessageDialog(TeTRESConfig.mainFrame, "Coordinates are required. Please set the location on the map.");
            return;
        }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel8)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tbxAttendance, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(tbxCoordinates, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
