...
class TICASObj(object):
    ...
    def _set_traffictype(self, samples_per_day):
        TrafficType.volume = TrafficType("volume", ".v30", 1, samples_per_day,
                                         "cumulative", "sum_in_rnode")
        TrafficType.occupancy = TrafficType("occupancy", ".o30", 2, samples_per_day,
                                            "density_with_station", "avg_in_rnode")
        TrafficType.scan = TrafficType("scan", ".c30", 2, samples_per_day, "average", "avg_in_rnode")
        TrafficType.density = TrafficType("density", ".c30", 2, samples_per_day,
                                          "density_with_station", "avg_in_rnode")
        TrafficType.speed = TrafficType("speed", "", 0, samples_per_day, "average", "avg_in_rnode")
        TrafficType.speed_wavetronics = TrafficType("speed_wavetronics", ".s30", 1, samples_per_day,
                                                    "average", "avg_in_rnode")
