...
if __name__ == "__main__":
    ...
    only_file_names = ["work_zone_2010.xlsx", "work_zone_2011.xlsx", "work_zone_2012.xlsx", "work_zone_2013.xlsx", "work_zone_2014.xlsx"]
    for only_file_name in only_file_names:
