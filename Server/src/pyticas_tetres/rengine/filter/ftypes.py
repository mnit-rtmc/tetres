...
class ExtData(Serializable):
    def __init__(self, tti, weather, incidents, workzones, specialevents, snowmanagements):
        """
        :type tti: pyticas_tetres.db.tetres.model.TravelTime
        :type weather: pyticas_tetres.db.tetres.model.TTWeather
        :type incidents: list[pyticas_tetres.db.tetres.model.TTIncident]
        :type workzones: list[pyticas_tetres.db.tetres.model.TTWorkzone]
        :type specialevents: list[pyticas_tetres.db.tetres.model.TTSpecialevent]
        :type snowmanagements: list[pyticas_tetres.db.tetres.model.TTSnowmgmt]
        """
