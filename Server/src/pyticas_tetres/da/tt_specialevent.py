...
from pyticas_tetres.ttypes import TTSpecialeventInfo


class TTSpecialeventDataAccess(DataAccess):
    def __init__(self, year, **kwargs):
        super().__init__(**kwargs)
        self.da_base = ExtDataAccessBase(year,
                                         model_yearly.get_tt_specialevent_table(year),
                                         model.Specialevent,
                                         TTSpecialeventInfo,
                                         **kwargs)
    ...
    def list(self, ttri_id, sdt, edt, **kwargs):
        ...
        :rtype: Union(list[TTSpecialeventInfo], list[model.Specialevent])
        """
    ...
    def insert(self, ttsei, **kwargs):
        """
        :type ttsei: TTSpecialeventInfo
        :rtype: model.TTWorkzone<Year>
        """
        return self.da_base.insert(ttsei, **kwargs)
