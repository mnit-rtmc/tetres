...
class Infra(object):
    ...
    **Traffic Data Reader**
    ...
    def __init__(self, metro_info):
        ...
        # faverolles 1/16/2020 NOTE: only use of det_reader.py
        #  which contains only use of det_reader_raw.py
        #  which is what downloads detector station files
        self.ddr = DetectorDataReader()
        """ :type: DetectorDataReader """

        # faverolles 1/16/2020 NOTE: Contains DetectorDataReader ddr above
