...
import ncrtes.api.EstimationClient;
...
//        JOptionPane.showMessageDialog(this, "Please wait until \"Done\" message is shown.\nResults can be found in \"Tools > Estimation Results\" menu on top");
    ...
    private void initComponents() {
        ...
        dtStartDate = new common.ui.TICASDateTimePicker();
        dtEndDate = new common.ui.TICASDateTimePicker();
    ...
    }private void btnSelectCorridorActionPerformed(java.awt.event.ActionEvent evt) {
        openSelectTargetCorridorDialog();
    }

    private void btnSelectTruckRoutesActionPerformed(java.awt.event.ActionEvent evt) {
        openSelectTargetTruckRouteDialog();
    }

    private void btnImportBareLaneRegainTimeActionPerformed(java.awt.event.ActionEvent evt) {
        openImportReportedTimeDialog();
    }

    private void btnEstimateActionPerformed(java.awt.event.ActionEvent evt) {
        doEstimation();
    }
    ...
    private common.ui.TICASDateTimePicker dtEndDate;
    private common.ui.TICASDateTimePicker dtStartDate;
