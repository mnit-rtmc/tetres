 ...
 */
package user.panels.estimation;
...
import user.UIHelper;
import user.api.EstimationAPIClient;
import user.api.ReliabilityRouteAPIClient;
import user.filters.IFilterListChangeListener;
import user.panels.routegroup.IRouteGroupListChangeListener;
...
import user.types.ReliabilityEstimationModeInfo;
import user.types.RouteGroupInfo;
import user.types.WeekdayConditionInfo;
...
import user.panels.operatingconditions.OCParamHelper;
...
public class PanelEstimation extends javax.swing.JPanel implements IInitializable, IFilterListChangeListener, IRouteGroupListChangeListener {
    ...
    private void loadRequestedInfo() {
        ...
        this.chkWriteMoeSpreadsheet.setSelected(prevEri.write_moe_spreadsheet);
    ...
    private EstimationRequestInfo getRequestOption() {
        ...
        // faverolles 10/8/2019:
        eri.write_moe_spreadsheet = this.chkWriteMoeSpreadsheet.isSelected();
...
//            setBorder(UIManager.getBorder("TableHeader.cellBorder"));
    ...
    private void initComponents() {
        ...
        jLabel9 = new JLabel();
        cbxCorridor = new common.ui.CorridorSelector();
        cbxRoute = new javax.swing.JComboBox<>();
        jLabel10 = new JLabel();
        jLabel3 = new JLabel();
        dtStartDate = new common.ui.TICASDatePicker();
        jLabel4 = new JLabel();
        dtEndDate = new common.ui.TICASDatePicker();
        jLabel5 = new JLabel();
        dtStartTime = new common.ui.TICASTimePicker();
        jLabel6 = new JLabel();
        dtEndTime = new common.ui.TICASTimePicker();
        jLabel7 = new JLabel();
        jLabel8 = new JLabel();
        chkSunday = new JCheckBox();
        ...
        chkExceptHolidays = new JCheckBox();
        jPanel6 = new javax.swing.JPanel();
        jLabel1 = new JLabel();
        chkModeTimeOfDay = new JCheckBox();
        chkModeWholeTime = new JCheckBox();
        jLabel2 = new JLabel();
        jScrollPane2 = new javax.swing.JScrollPane();
        tblFilters = new JTable();
        jLabel11 = new JLabel();
        chkOutputSpreadsheets = new JCheckBox();
        chkOutputGraphs = new JCheckBox();
        jButton4 = new javax.swing.JButton();

        // faverolles 10/8/2019:
        chkWriteMoeSpreadsheet = new JCheckBox();
        ...
        tblFilters.setModel(new DefaultTableModel(
                new Object [][] {
        ...
        // faverolles 10/8/2019:
        chkWriteMoeSpreadsheet.setSelected(false);
        chkWriteMoeSpreadsheet.setText("Include MOE Spreadsheet");
                                                        ...
                                                        .addGroup(jPanel6Layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                        ...
                                                                        .addGroup(jPanel6Layout.createSequentialGroup()
                                                                                ...
                                                                                .addGap(18, 18, 18)
                                                                                .addComponent(chkWriteMoeSpreadsheet)
                                                                        ))))
                                                .addGap(0, 0, Short.MAX_VALUE)))
                                .addContainerGap())
        );
    ...
    private void tabRouteSelectionStateChanged(javax.swing.event.ChangeEvent evt) {
        onRouteSelectTabChanged();
    }


    private common.ui.CorridorSelector cbxCorridor;
    private javax.swing.JComboBox<ReliabilityRouteInfo> cbxRoute;
    private javax.swing.JComboBox<RouteGroupInfo> cbxRouteGroups;
    private JCheckBox chkExceptHolidays;
    private JCheckBox chkFriday;
    private JCheckBox chkModeTimeOfDay;
    private JCheckBox chkModeWholeTime;
    private JCheckBox chkMonday;
    private JCheckBox chkOutputGraphs;
    private JCheckBox chkOutputSpreadsheets;
    ...
    private common.ui.TICASDatePicker dtEndDate;
    private common.ui.TICASTimePicker dtEndTime;
    private common.ui.TICASDatePicker dtStartDate;
    private common.ui.TICASTimePicker dtStartTime;
    ...
    // faverolles 10/8/2019:
    private JCheckBox chkWriteMoeSpreadsheet;
