...
public final class PanelRouteGroup extends javax.swing.JPanel implements IInitializable, IRouteGroupListChangeListener {
    ...
    private void initComponents() {
        ...
        btnAddRouteGroup.addActionListener(new ActionListener() {
        ...
        btnDeleteRouteGroup.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        btnEditRouteGroup.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        btnDeleteRouteList.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        btnAddRouteList.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
    ...
    }private void btnAddRouteGroupActionPerformed(ActionEvent evt) {
        this.addRouteGroup();
    }

    private void btnDeleteRouteGroupActionPerformed(ActionEvent evt) {
        this.deleteRouteGroup();
    }

    private void btnEditRouteGroupActionPerformed(ActionEvent evt) {
        this.editRouteGroup();
    }

    private void btnDeleteRouteListActionPerformed(ActionEvent evt) {
        this.deleteRouteList();
    }

    private void btnAddRouteListActionPerformed(ActionEvent evt) {
        this.addRouteList();
    }
