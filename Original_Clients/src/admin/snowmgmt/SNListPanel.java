...
import admin.snowmgmt.SNECreateDialog;
import admin.snowmgmt.SNMCreateDialog;
import admin.snowmgmt.SNMEditDialog;
...
public class SNListPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        tbSNEList.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        tbSnowMgmtInfo.setModel(new DefaultTableModel(
            new Object [][] {
    ...
    }private void btnDeleteSnowEventActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void btnAddSnowMgmtActionPerformed(java.awt.event.ActionEvent evt) {
        this.addSnowMgmtData();
    }

    private void btnDeleteMgmtInfoActionPerformed(java.awt.event.ActionEvent evt) {
        this.deleteSnowManagement();
    }

    private void btnEditMgmtInfoActionPerformed(java.awt.event.ActionEvent evt) {
