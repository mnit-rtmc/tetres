...
public class TimePanel extends javax.swing.JPanel {
    ...
    }private void cbxStartHourActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void cbxEndHourActionPerformed(java.awt.event.ActionEvent evt) {
        int slt1 = this.cbxStartHour.getSelectedIndex();
        int slt2 = this.cbxEndHour.getSelectedIndex();
        if (slt1 > slt2) {
    ...
    private void cbxDurationActionPerformed(java.awt.event.ActionEvent evt) {
        selectDuration();
    }
